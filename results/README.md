...
|  toss ![#f03c15](https://via.placeholder.com/15/f03c15/000000?text=+)   | throw (something) somewhere lightly, easily, or casually / shake or turn (food) in a liquid, so as to coat it lightly [4] |
|  trim   |                        |
|  whip   |                        |
|  wipe   |                        |
