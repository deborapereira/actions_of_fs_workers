...
book = 'IT'; % better to use US for the "On cooking" book
...
exclude_unrelated_to_movement= ["accept","admit","advertise","advise","afford",...
    ...
    "dismiss","dispatch","distribute","drop","employ","encourage",...
    ...
    "starch","state","stimulate","stir-fried","suffer","sun-dried",...
...
exclude_process = ["fry","pan-fry","grill","bake","roast","melt",...
    ...
    "sear","curdle","breed","stir-fry","distill","microwave",...
